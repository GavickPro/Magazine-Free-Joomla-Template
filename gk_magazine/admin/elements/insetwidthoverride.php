...
class JFormFieldInsetWidthOverride extends JFormField
{
	...
	protected function getInput() {		
		...
		$html .= '<div class="input-prepend"><input type="text" value="" id="inset_width_for_pages_select" /><span class="add-on">%</span>';
		$html .= '<input type="button" class="btn" value="'.JText::_('TPL_GK_LANG_ADD_RULE').'" id="inset_width_for_pages_add_btn" /></div>';
