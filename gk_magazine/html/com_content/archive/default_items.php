	...
	<header>
		...
		<?php if (($params->get('show_author')) or ($params->get('show_parent_category')) or ($params->get('show_category')) or ($params->get('show_create_date')) or ($params->get('show_modify_date')) or ($params->get('show_publish_date'))  or ($params->get('show_hits')) or ($params->get('show_create_date')) ) : ?>
			<ul>				
				...
				<li class="modified">
                  <time datetime="<?php echo JHtml::_('date', $item->modified, DATE_W3C); ?>">
                  	<?php echo JHtml::_('date', $item->modified, JText::_('F j, Y')); ?>
                  </time>
				</li>
				<?php endif; ?>
				...
				<li class="published">
                  <time datetime="<?php echo JHtml::_('date', $item->publish_up, DATE_W3C); ?>">
                  	<?php echo JHtml::_('date', $item->publish_up, JText::_('F j, Y')); ?>
                  </time>
				</li>
				<?php endif; ?>
